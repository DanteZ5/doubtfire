...
{ email: 'raymonde@wanadoo.fr', password: '123456', first_name: 'Raymonde',
  ...
  photo: "http://www.digitaljournal.com/img/5/6/2/4/4/2/i/8/6/8/o/Grandma_37.JPG",
  age: 78 },
{ email: 'françoise@wanadoo.fr', password: '123456', first_name: 'Françoise',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://az616578.vo.msecnd.net/files/2016/03/18/635939287221105035-638973208_grandma17.jpg",
  age: 78 },
{ email: 'jacqueline@wanadoo.fr', password: '123456', first_name: 'Jacqueline',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://utahvalley360.com/wp-content/uploads/2013/09/oramaeheadshot.jpg",
  age: 78 },
{ email: 'yvette@wanadoo.fr', password: '123456', first_name: 'Yvette',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://3.bp.blogspot.com/-qv77t5owRBI/WScUo7h1mbI/AAAAAAAAbn8/JY0LZ8HaQI4T7EIQSCGDuFnDbTuPb8c5QCLcB/s1600/IMG_6493.JPG",
  age: 78 },
{ email: 'geraldine@wanadoo.fr', password: '123456', first_name: 'Géraldine',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "http://2.bp.blogspot.com/-PGQbwleVMuY/Tz80xqa9gaI/AAAAAAAAAv4/aBtWCp5oWJU/s1600/Grandma%2527s+new+hair+cut+feb+002.jpg",
  age: 78 },
{ email: 'elisabeth@wanadoo.fr', password: '123456', first_name: 'Elisabeth',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "http://littlepinkstudio.typepad.com/.a/6a00d83453a88469e201a3fb67e159970b-pi",
  age: 78 },
{ email: 'martine@wanadoo.fr', password: '123456', first_name: 'Martine',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://farm4.static.flickr.com/3480/3895535691_101496c0eb_b.jpg",
  age: 78 },
{ email: 'mireille@wanadoo.fr', password: '123456', first_name: 'Martine',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://i1.wp.com/comedyzone.com/wp-content/uploads/2016/08/grandma-lee-small.jpg?fit=1200%2C1200&ssl=1",
  age: 78 },
{ email: 'dante@gmail.com', password: '123456', first_name: 'Dante',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://kitt.lewagon.com/placeholder/users/DanteZ5",
  age: 34 },
{ email: 'nassim@gmail.com', password: '123456', first_name: 'Nassim',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://kitt.lewagon.com/placeholder/users/moneynass",
  age: 33 },
{ email: 'thibaud@gmail.com', password: '123456', first_name: 'Thibaud',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://kitt.lewagon.com/placeholder/users/tvuit",
  age: 33 },
{ email: 'maximilien@gmail.com', password: '123456', first_name: 'Maximilien',
  ...
  Catone; aut enim nemo, quod quidem magis credo, aut si quisquam,
   ille sapiens fuit. Quo modo, ut alia omittam, mortem filii tulit! memineram Paulum,
  videram Galum, sed hi in pueris, Cato in perfecto et spectato viro.",
  photo: "https://kitt.lewagon.com/placeholder/users/MaxR7589",
  age: 28 },
]
...
booking_attributes = [
{ user_id: users.first.id, grandma_id: grandmas.first.id, status: "validate",
  start_date: "12/03/2018", end_date: "14/03/2018"  },
{ user_id: users.first.id, grandma_id: grandmas.first.id, status: "declined",
...
{ user_id: users.first.id, grandma_id: grandmas.second.id, status: "pending",
